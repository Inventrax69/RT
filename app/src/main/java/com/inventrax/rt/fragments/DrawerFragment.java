...
import com.inventrax.rt.adapters.NavigationDrawerAdapter;
    ...
    public List<NavDrawerItem> getMenuItemsByUserType(String userType) {
        ...
        switch (userType) {
            ...
            case "1": {
                ...
                menuList.add(new NavDrawerItem("Batch Picking", R.drawable.go));
                menuList.add(new NavDrawerItem("Internal Transefer", R.drawable.go));
            }
